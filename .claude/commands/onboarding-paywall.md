...
1. docs/sistema/02B-ONBOARDING-MONETIZACION.md  ← LA MÁS IMPORTANTE: estrategia y datos
2. docs/sistema/52-COPY-VISUALES-CONVERSION.md  ← copy, visuales, marca, garantia concreta
3. docs/sistema/50-DISENO-ONBOARDING-PAYWALL.md ← medidas exactas de onboarding/paywall
4. docs/sistema/15-PATRONES-UX.md               ← micro-compromisos, empty states, auth
5. docs/sistema/14-LEYES-DE-DISENO.md           ← specs exactas de jerarquía y espaciado
6. docs/sistema/22-LIBRERIAS-Y-CRAFT.md         ← librerías de animación (Motion, Lottie)
7. docs/sistema/11-DISENO-EMOCIONAL.md          ← personalidad, celebración, ritmo
8. docs/sistema/12-FLUJO-AGENTICO.md            ← Protocolo de Rescate R1-R5
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Audita el onboarding y paywall actuales contra docs/sistema/02B-ONBOARDING-MONETIZACION.md.
...
□ ¿La longitud del onboarding corresponde al NICHO (matriz A-F de 02B: 15-25 bienestar/fitness · ultra corto IA creativa · ≤5 utilidad)?
...
1. DECISIÓN ESTRATÉGICA (respeta el ORDEN DE DISEÑO de 02B: tipo de app → promesa → frecuencia →
   ...
   - Elige la estrategia del NICHO en la matriz A-F de 02B (educación, bienestar, fitness, IA creativa,
...
4. IMPACTO ESPERADO: estimación de mejora de conversión basada en los benchmarks de 02B
...
→ Rediseñar el paywall con la anatomía exacta de 02B-ONBOARDING-MONETIZACION.md (que responda las 7 preguntas)
