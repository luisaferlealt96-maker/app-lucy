...
margen, LTV:CAC), 02-VALIDACION.md y 02B-ONBOARDING-MONETIZACION.md (WTP y estrategia de
pricing/paywall), 35-LANZAMIENTO-Y-RETENCION.md (la promesa de fundadores y la renovación anual),
...
FASE 3 — ACTUALIZACIÓN COORDINADA (todo el mismo día, en este orden):
  ...
  3. PAYWALL in-app (02B): la pantalla de planes muestra el precio nuevo (y a los fundadores, el
